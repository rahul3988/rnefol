              ...
              {filteredInvoices.map((invoice) => (
                <tr key={invoice.id} className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-3 px-4">
                    <Link to={`/invoice/${invoice.id}`} className="text-brand-primary hover:underline font-medium">
                  ...
                  <td className="py-3 px-4">
                    <Link to={`/orders/${invoice.orderId}`} className="text-brand-primary hover:underline">
                      {invoice.orderId || 'N/A'}
                    </Link>
                  </td>
