// Database schema for comprehensive user activity tracking
import { Pool } from 'pg'

export async function createUserActivityTables(pool: Pool) {
  try {
...
export async function updateUserStats(pool: Pool, userId: number) {
  try {
