// Script to update all products with MRP and discounted pricing
import { Pool } from 'pg'

export async function updateAllProductsWithPricing(pool: Pool) {
  try {
...
export async function addSampleProducts(pool: Pool) {
  try {
